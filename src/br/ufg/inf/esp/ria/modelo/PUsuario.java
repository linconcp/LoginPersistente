...
public class PUsuario extends SQLiteOpenHelper {
  ...
  private static final String COLUNA_IDENTIFICACAO = "identificacao";
  private static final String COLUNA_NOME = "nome";
  private static final String COLUNA_SENHA = "senha";

  public PUsuario(Context contexto) {
    super(contexto, BANCO_DADOS, null, VERSAO_DB);
  }

  @Override
  public void onCreate(SQLiteDatabase db) {
    final String CREATE_USUARIO = "CREATE TABLE " + TABELA + "(" + COLUNA_ID + " INTEGER PRIMARY KEY, "
        + COLUNA_IDENTIFICACAO + " TEXT UNIQUE, " + COLUNA_NOME + " TEXT UNIQUE, " + COLUNA_SENHA + " TEXT)";
  ...
  public EUsuario consultar(EUsuario eUsuario) {
    ...
    Cursor cursor = db.query(TABELA, null, COLUNA_IDENTIFICACAO + "= ?",
        new String[] { String.valueOf(eUsuario.getIdentificacao()) }, null, null, null, null);
    ...
    if (cursor != null) {
      ...
      eUsuarioAux.setIdentificacao(cursor.getString(1));
      eUsuarioAux.setNome(cursor.getString(2));
      eUsuarioAux.setSenha(cursor.getString(3));
